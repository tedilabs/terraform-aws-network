...
|------|-------------|------|---------|:--------:|
| <a name="input_name"></a> [name](#input\_name) | Desired name for the VPC Interface Endpoint. | `string` | n/a | yes |
...
| <a name="input_subnets"></a> [subnets](#input\_subnets) | The ID of one or more subnets in which to create a network interface for the endpoint. | `list(string)` | n/a | yes |
...
| <a name="input_security_group_ids"></a> [security\_group\_ids](#input\_security\_group\_ids) | The ID of one or more security groups to associate with the network interface. | `list(string)` | `[]` | no |
