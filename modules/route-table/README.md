...
| <a name="output_name"></a> [name](#output\_name) | The name of the routing table. |
| <a name="output_owner_id"></a> [owner\_id](#output\_owner\_id) | The ID of the AWS account that owns subnets in the routing table. |
